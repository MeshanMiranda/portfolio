...
import { SiMongodb, SiMysql, SiPhp, SiCplusplus, SiJquery, SiExpress, SiAdobeillustrator, SiGithub, SiFlutter, SiFastapi, SiTensorflow, SiFirebase } from "react-icons/si"
        ...
        <div className="pt-[60px]">
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    className="p-2 md:p-4 flex flex-col items-center justify-center text-center"
                >
                    <SiTensorflow className="text-4xl md:text-7xl text-yellow-500" />
                    <p>TensorFlow</p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="p-2 md:p-4 flex flex-col items-center justify-center text-center"
                >
                    <SiFastapi className="text-4xl md:text-7xl text-blue-500" />
                    <p>FastAPI</p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="p-2 md:p-4 flex flex-col items-center justify-center text-center"
                >
                    <SiFlutter className="text-4xl md:text-7xl text-gray-300" />
                    <p>Flutter</p>
                </motion.div>
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    className="p-2 md:p-4 flex flex-col items-center justify-center text-center"
                >
                    <SiFirebase className="text-4xl md:text-6xl text-orange-500" />
                    <p>Firebase</p>
                </motion.div>
